function demeritPointCalculator() {
    ...
    // Consequences from the number of demerit points calculated
        if (numberOfDemeritPoints < 12 ) {
          console.log(`Speeding by ${speed - 70} km/h, leading to  ${numberOfDemeritPoints} demerit points.`);
          window.alert(`Speeding by ${speed - 70} km/h, leading to  ${numberOfDemeritPoints} demerit points.`);
